...
/*
 * A simple function to get the port number of a packet
 *
 * @buf: The buffer containing the raw datagram
 * @len: The length of the packet-buffer in bytes
 * Returns: The the source port
*/
unsigned short getPort(char *buf, int len)
{
	struct iphdr ip_hdr;
	short ip_hdr_len;
